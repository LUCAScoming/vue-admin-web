  ...
  <div id="owner-container" style="margin:20px;">
    <el-form ref="form" :inline="true" :model="managerQueryVo">
      <el-form-item v-model="value">
        <el-input placeholder="请输入文件编号/文件名称"/>
      </el-form-item>
      <el-form-item>
    ...
    <el-table v-loading="loading" :data="tableData">
      <el-table-column prop="ownerId" label="文件编号" width="120"/>
      <el-table-column prop="ownerName" label="文件名称" width="120"/>
      <el-table-column prop="sex" label="播放区域" width="120"/>
      <el-table-column prop="phone" label="周期播放" width="120"/>
      <el-table-column prop="building" label="时间" width="120"/>
      <el-table-column prop="time" label="播放次数" width="120"/>
      <el-table-column label="操作" width="">
        <template slot-scope="scope">
          <el-button size="mini" type="primary" >一键播放</el-button>
